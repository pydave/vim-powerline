...
let g:Powerline#Colorschemes#solarized256#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['fileinfo.flags'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['currenttag', 'fullcurrenttag', 'fileformat', 'fileencoding', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'asynccommand:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup'], {
		\ 'n': ['gray5', 'gray2'],
		\ 'i': ['mediumcyan', 'base02'],
		\ }),
	\
